...
class LogisticRegression():
    def __init__(self , fit_intercept=True, C=1.0 , penalty='l2' , max_iter=100 , learning_rate=0.01 , tol=1e-4):
    ...
    def fit(self, X , y):
        ...
        for _ in range(self.max_iter):
            ...
            error = y_probabilites - np.eye(num_classes)[y.astype(int)]
            gradient = X.T @ error
            gradient = self.regularize_gradient(gradient)
